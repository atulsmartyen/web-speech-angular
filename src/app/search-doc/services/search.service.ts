...
export class SearchService {
  private apiUrl = 'https://func-curator.azurewebsites.net/api/query-prompt-docs?prompt=';
  private videoAPIurl = 'https://func-curator.azurewebsites.net/api/query-prompt-videos?prompt=';
